const Contact = () => (
  <section className="py-20 px-4 max-w-xl mx-auto text-center">
    ...
    <div className="space-y-3 text-lg">
      ...
      <p><strong>LinkedIn:</strong> <a className="text-teal-600 hover:underline" href="https://www.linkedin.com/in/your-link/" target="_blank" rel="noreferrer">linkedin.com/in/your-link</a></p>
